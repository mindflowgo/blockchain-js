...
export default class Ledger {
    ...
    reset(){
        ...
        addresses.forEach( publicKey => {
            ...
            this.wallets[publicKey].blockSeq = 0
    ...
    getWallet(name) {
        ...
        if( this.wallets[publicKey] === undefined )
            this.wallets[publicKey] = { name, created: time(), publicKey, blockSeq: 0, seq: 0, balance: 0 }
    ...
    updateWallet(name, walletData={}) {
        ...
        const wallet = { ...this.wallets[publicKey] || {blockSeq: 0, seq: 0, balance: 0}, ...walletData, publicKey }
