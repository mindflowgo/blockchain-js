...
export default class Block {
    ...
    constructor({ index = 0, prevHash = '0', version = '', timestamp = time(), minerName, merkleRoot = '0', nonce = 0, 
        ...
        let defaults = {
            ...
            powTime,
            // ------------------------
            // used locally but not written anywhere
            options,
    ...
    getData( hashableDataOnly = false ) {
        const blockData = {
            // -- HASH CALCULATED ON --
            index: this.index,
